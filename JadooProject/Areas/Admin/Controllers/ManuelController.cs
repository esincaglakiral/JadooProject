...
namespace JadooProject.Areas.Admin.Controllers
{
    ...
    public class ManuelController : Controller
    {
        ...
        public ManuelController(IMapper mapper, GetManuelQueryHandler manuelQueryHandler, GetManuelByIdQueryHandler manuelByIdQueryHandler, CreateManuelCommandHandler createManuelCommandHandler, UpdateManuelCommandHandler updateManuelCommandHandler, RemoveManuelCommandHandler removeManuelCommandHandler)
        {
            _mapper = mapper;
